...
VALUES
    ('Ivan', 'Miratov', 'miratov267@email.com', "5094689183"),
    ('Janika', 'Eisel', 'janeisel@email.com', "5097293517"),
...
INSERT INTO CampgroundSites (GroundSiteId, SiteNumber)
VALUES ((SELECT CampgroundId FROM Campgrounds WHERE CampgroundId=1), 3);
...
INSERT INTO CampgroundSites (GroundSiteId, SiteNumber)
VALUES ((SELECT CampgroundId FROM Campgrounds WHERE CampgroundId=2), 3);
...
VALUES
    ...
    (
        (SELECT SiteId FROM CampgroundSites WHERE SiteId=3),
